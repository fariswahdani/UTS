...
public class MainActivity extends AppCompatActivity
    ...
    public void pindahFragment(int viewId) {
        ...
        switch (viewId) {
            case R.id.nav_pesan:
                Intent a = new Intent(MainActivity.this, ListMakanan.class);
                startActivity(a);
                break;
            case R.id.nav_booking:
                Intent b = new Intent(MainActivity.this, Booking.class);
                startActivity(b);
                break;
            case R.id.nav_about:
            ...
            case R.id.nav_history:
                Intent e = new Intent(MainActivity.this, History.class);
                startActivity(e);
                break;
        ...
        if (fragment!=null){
            ...
            ft.replace(R.id.txt_deskripsi, fragment);
            ft.commit();
        }
